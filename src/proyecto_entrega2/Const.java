 ...
 * en las diferentes posiciones del mapa. 
 *
 *
 */
public class Const {
    ...
    /**
     * Nombre relativo del archivo en el que está la imágen de la espada
     */
    public static final String ARCHIVO_ESPADA = "/imagenes/sword.png";
    /**
     * Nombre relativo del archivo en el que está la imágen del abanico
     */
    public static final String ARCHIVO_ABANICO = "/imagenes/fan.png";
    /**
    ...
    /**
     * Nombre relativo del archivo en el que está la imágen del huracan
     */
    ...
    /**
     * Caracter que en el mapa de caracteres de Nivel  indica que en esa posición está el
     * jugador.
     */
    public static final char CELDA_POSICION_INICIAL_JUGADOR = 'J';
    /**
     * Caracter que en el mapa de caracteres de Nivel  indica que la celda está vacía.
     */
    public static final char CELDA_NORMAL = ' ';
    /**
     * Caracter que en el mapa de caracteres de Nivel  indica que en esa posición hay una
     * pared.
     */
    public static final char CELDA_PARED = '#';
    /**
     * Caracter que en el mapa de caracteres de Nivel  indica que en esa posición está la
     * puerta.
     */
    ...
    /**
     * Caracter que en el mapa de caracteres de Nivel indica que en esa posición hay un
     * soplete.
     */
    ...
    /**
     * Caracter que indica presencia de abanico.
     */
    public static final char CELDA_ABANICO = 'W';
    /**
     * Caracter que indica presencia de huracan.
     */
    public static final char CELDA_HURACAN = 'V';
    /**
     * Caracter que indica presencia de espada.
     */
